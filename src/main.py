...
def main(datetime_str: str) -> str:
    ...
    try:
        ...
        cards_analysis_json = analyze_transactions("../data/operations.xlsx", date_time)
        top_transactions_json = get_top_transactions(date_time)
        exchange_rates = get_exchange_rates()
        stock_prices = get_stock_prices(api_key=os.getenv("alphavantage_co_API_KEY"), settings_file="../user_settings.json", date=date_time)
